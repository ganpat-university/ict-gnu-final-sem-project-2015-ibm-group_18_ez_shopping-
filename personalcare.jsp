									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/pc1.png"/>"></a>		
												<p>Baby Lotion</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Baby Lotion" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/pc2.png"/>"></a>		
												<p>Rash Cream</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Rash Cream" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/pc3.png"/>" alt=" " class="img-responsive"></a>
												<p>Rash Cream</p>
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/pc4.png"/>"></a>		
												<p>Rash Cream</p>
												<h4>$35 <span>$55</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/pc5.png"/>"></a>		
												<p>Baby Lotion</p>
												<h4>$30 <span>$45</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Baby Lotion" />
														<form:input type="hidden" path="amount" name="amount" value="3" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/pc6.png"/>" alt=" " class="img-responsive"></a>
												<p>Rash Cream</p>
												<h4>$80 <span>$105</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/pc7.png"/>"></a>		
												<p>Baby Lotion</p>
												<h4>$35 <span>$55</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/pc8.png"/>"></a>		
												<p>Wipes Gentle</p>
												<h4>$30 <span>$45</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Wipes Gentle" />
														<form:input type="hidden" path="amount" name="amount" value="30" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/pc9.png"/>" alt=" " class="img-responsive"></a>
												<p>Rash Cream</p>
												<h4>$80 <span>$105</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
