									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/bv2.png"/>"></a>		
												<p>Frooti</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
														...
														<form:input type="hidden" path="item" name="item_name" value="Frooti" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/bv3.png"/>"></a>		
												<p>Tropicana</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														<form:input type="hidden" path="add" name="add" value="1" />
														<form:input type="hidden" path="item" name="item_name" value="Tropicana" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/bv4.png"/>" alt=" " class="img-responsive"></a>
												<p>Tropicana</p>
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/bv5.png"/>"></a>		
												<p>Coca Cola</p>
												<h4>$35 <span>$55</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Coca Cola" />
														<form:input type="hidden" path="amount" name="amount" value="35" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/bv6.png"/>"></a>		
												<p>Coca Cola</p>
												<h4>$30 <span>$45</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/bv7.png"/>" alt=" " class="img-responsive"></a>
												<p>Appy</p>
												<h4>$80 <span>$105</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Appy" />
														<form:input type="hidden" path="amount" name="amount" value="80" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/bv8.png"/>"></a>		
												<p>Real</p>
												<h4>$35 <span>$55</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Real" />
														<form:input type="hidden" path="amount" name="amount" value="35" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/bv9.png"/>"></a>		
												<p>Red Bull</p>
												<h4>$30 <span>$45</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Red Bull" />
														<form:input type="hidden" path="amount" name="amount" value="30" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/bv1.png"/>" alt=" " class="img-responsive"></a>
												<p>Minute Maid</p>
												<h4>$80 <span>$105</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Minute Maid" />
														<form:input type="hidden" path="amount" name="amount" value="80" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
