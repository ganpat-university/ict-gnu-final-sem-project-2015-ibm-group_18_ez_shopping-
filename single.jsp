		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="<c:url value="/resources/images/si1.jpg"/>" alt=" " class="img-responsive">
				</div>
				...
				<h2>KHARAMORRA Khakra - Hariyali</h2>
					...
					<div class="w3agile_description">
						<h4>Description :</h4>
						<p>we also offer Hariyali Khakhra that is extremely crispy and tasty. The offered khakhra is extensively demanded as a popular and healthy snack to be eaten during the breakfast or evening time. This khakhra is prepared using optimal quality basic ingredients and progressive methodology to obtain its crunchiness and impeccable taste. Clients can purchase this Hariyali Khakhra from us in different hygienic packaging options at pocket friendly prices..</p>
					</div>
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4 class="m-sing">$21 <span>$25</span></h4>
						</div>
