...
%><a>welcome ${email}</a>  </li>

					
				</ul>
			</div>
			<div class="product_list_header">  
					<form:form action="checkout" method="post" class="last"> 
						
						<form:input type="hidden" name="cmd" value="${ email}" path="email"/>
											...
											<div class="agile_top_brand_left_grid1">
												<figure>
													...
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Fortune Sunflower" />
														<form:input type="hidden" path="amount" name="amount" value="20" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="amount" name="amount" value="45" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
