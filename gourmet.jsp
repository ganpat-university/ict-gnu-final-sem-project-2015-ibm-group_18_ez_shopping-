...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>s<!DOCTYPE html>
<html>
<head>
									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/gu1.png"/>"></a>		
												<p>Milk Caramel</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Milk Caramel" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/gu2.png"/>"></a>		
												<p>Gourmet</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Gourmet" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/gu3.png"/>" alt=" " class="img-responsive"></a>
												<p>Strawberry</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Strawberry" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/gu4.png"/>"></a>		
												<p>Miniatures</p>
												<h4>$35 <span>$55</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Miniatures" />
														<form:input type="hidden" path="amount" name="amount" value="35" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/gu5.png"/>"></a>		
												<p>Le-Gourmet</p>
												<h4>$30 <span>$45</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Le-Gourmet" />
														<form:input type="hidden" path="amount" name="amount" value="30" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/gu6.png"/>" alt=" " class="img-responsive"></a>
												<p>Chocolate Bar</p>
												<h4>$80 <span>$105</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Chocolate Bar" />
														<form:input type="hidden" path="amount" name="amount" value="80" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="/resources/images" value="<c:url value="/resources/images/gu7.png"/>"/></a>		
												<p>Poultry Rub</p>
												<h4>$35 <span>$55</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Poultry Rub" />
														<form:input type="hidden" path="amount" name="amount" value="35" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="/resources/images" value="<c:url value="/resources/images/gu8.png"/>"/>></a>		
												<p>Sandwich</p>
												<h4>$30 <span>$45</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Sandwich" />
														<form:input type="hidden" path="amount" name="amount" value="30" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/gu9.png"/>" alt=" " class="img-responsive"></a>
												<p>Fruit Nut</p>
												<h4>$80 <span>$105</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Fruit Nut" />
														<form:input type="hidden" path="amount" name="amount" value="80" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
