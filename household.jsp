									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/hh1.png"/>"></a>		
												<p>Fry Pan</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Fry Pan" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/hh2.png"/>"></a>		
												<p>Cookware</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Cookware" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/hh3.png"/>" alt=" " class="img-responsive"></a>
												<p>Dosa Tawa</p>
											...
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Dosa Tawa" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/hh4.png"/>"></a>		
												<p>Flask</p>
												<h4>$35 <span>$55</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Flask" />
														<form:input type="hidden" path="amount" name="amount" value="35" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/hh5.png"/>"></a>		
												<p>Kadai Idly</p>
												<h4>$30 <span>$45</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Kadai Idly" />
														<form:input type="hidden" path="amount" name="amount" value="30" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/hh6.png"/>" alt=" " class="img-responsive"></a>
												<p>Breakfast Pan</p>
												<h4>$80 <span>$105</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Breakfast Pan" />
														<form:input type="hidden" path="amount" name="amount" value="80" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/hh7.png"/>"></a>		
												<p>Elite Set</p>
												<h4>$35 <span>$55</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Elite Set" />
														<form:input type="hidden" path="amount" name="amount" value="35" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img title=" " alt=" " src="<c:url value="/resources/images/hh8.png"/>"></a>		
												<p>Coated Pan</p>
												<h4>$30 <span>$45</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Coated Pan" />
														<form:input type="hidden" path="amount" name="amount" value="30" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
							...
							<div class="agile_top_brand_left_grid">
								...
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single"><img src="<c:url value="/resources/images/hh9.png"/>" alt=" " class="img-responsive"></a>
												<p>Tadka Pan</p>
												<h4>$80 <span>$105</span></h4>
											</div>
											<div class="snipcart-details top_brand_home_details">
												<form:form action="cart" method="post">
													<fieldset>
														...
														<form:input type="hidden" path="item" name="item_name" value="Tadka Pan" />
														<form:input type="hidden" path="amount" name="amount" value="80" />
														<form:input type="hidden" path="discount" name="discount_amount" value="1" />
														<form:input type="hidden" path="email" name="email" value="${email}" />
														<form:input type="hidden" path="currency" name="currency_code" value="USD" />
